/**
 * Exports batch1Pages (40 expanded about pages) for merge-about-expanded.mjs.
 * Run merge: node scripts/merge-about-expanded.mjs
 */
...
export const batch1Pages = pages;

if (batch1Pages.length !== 40) {
  throw new Error(`Expected 40 pages, got ${batch1Pages.length}`);
}

const slugs = new Set(batch1Pages.map((p) => p.slug));
if (slugs.size !== 40) {
