/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0210a2c29be24f8ba7f221db983ff1e)
// Runtime types generated with workerd@1.20260625.1 2026-04-28 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	HISTORY_ARCHIVE: R2Bucket;
	MAILER: SendEmail;
	BROWSER: BrowserRun;
	...
	NEXT_PUBLIC_OPENWEATHER_CITY_ID: string;
	SMTP_HOST: string;
	...
	STRIPE_DISPLAY_MEMBER_MONTHLY: string;
	STRIPE_DISPLAY_MEMBER_ANNUAL: string;
	STRIPE_DISPLAY_PRO_MONTHLY: string;
	STRIPE_DISPLAY_PRO_ANNUAL: string;
	STRIPE_PRICE_ID_ANNUAL: string;
	PRICING_DEFAULT_INTERVAL: string;
	...
	STRIPE_DISPLAY_PORTFOLIO_MONTHLY: string;
	STRIPE_DISPLAY_PORTFOLIO_ANNUAL: string;
	STRIPE_PRICE_ID_PORTFOLIO: string;
	STRIPE_PRICE_ID_PORTFOLIO_ANNUAL: string;
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	YUBICO_CLIENT_ID: string;
	YUBICO_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "DATABASE_URL" | "NEXT_PUBLIC_OPENWEATHER_API_KEY" | "NEXT_PUBLIC_OPENWEATHER_CITY_ID" | "SMTP_HOST" | "SMTP_STARTTLS" | "SMTP_SSL" | "SMTP_USER" | "SMTP_PASSWORD" | "SMTP_PORT" | "SMTP_MAIL_FROM" | "SMTP_MAIL_TO" | "EMAIL_BACKEND" | "RECAPTCHA_SITE_KEY" | "RECAPTCHA_SECRET_KEY" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_ID" | "SITE_URL" | "CRON_SECRET" | "SUPABASE_SERVICE_ROLE_KEY" | "STRIPE_PRICE_ID_PRO" | "STRIPE_PRICE_ID_PRO_ANNUAL" | "STRIPE_DISPLAY_MEMBER_MONTHLY" | "STRIPE_DISPLAY_MEMBER_ANNUAL" | "STRIPE_DISPLAY_PRO_MONTHLY" | "STRIPE_DISPLAY_PRO_ANNUAL" | "STRIPE_PRICE_ID_ANNUAL" | "PRICING_DEFAULT_INTERVAL" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "E2E_TEST_EMAIL" | "E2E_TEST_PASSWORD" | "FCM_SERVICE_ACCOUNT_JSON" | "SENTRY_DSN" | "SENTRY_PROJECT" | "SENTRY_ORG" | "PUBLIC_SENTRY_DSN" | "SENTRY_AUTH_TOKEN" | "TWILIO_ACCOUNT_SID" | "TWILIO_AUTH_TOKEN" | "TWILIO_FROM_NUMBER" | "SENTRY_URL" | "OPS_DISCORD_WEBHOOK_URL" | "STRIPE_DISPLAY_PORTFOLIO_MONTHLY" | "STRIPE_DISPLAY_PORTFOLIO_ANNUAL" | "STRIPE_PRICE_ID_PORTFOLIO" | "STRIPE_PRICE_ID_PORTFOLIO_ANNUAL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "YUBICO_CLIENT_ID" | "YUBICO_API_KEY">> {}
}
